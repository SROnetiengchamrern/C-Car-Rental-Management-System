...
public static class DemoSeedData
{
    ...
    private static void SeedContracts(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<RentalContract>().HasData(
            new RentalContract { ContractId = 1, CustomerId = 1, EmployeeId = 2, BranchId = 1, ContractNumber = "RC-2025-0001", StartDate = new DateTime(2025, 6, 1), EndDate = new DateTime(2025, 6, 5), Status = "Completed", TotalAmount = 150m, DiscountAmount = 0m, DepositAmount = 50m, Notes = "City trip", CreatedAt = new DateTime(2025, 5, 28) },
            new RentalContract { ContractId = 2, CustomerId = 2, EmployeeId = 3, BranchId = 2, ContractNumber = "RC-2025-0002", StartDate = new DateTime(2025, 6, 10), EndDate = new DateTime(2025, 6, 14), Status = "Completed", TotalAmount = 400m, DiscountAmount = 20m, DepositAmount = 100m, Notes = "Temple tour", CreatedAt = new DateTime(2025, 6, 8) },
            new RentalContract { ContractId = 3, CustomerId = 3, EmployeeId = 2, BranchId = 1, ContractNumber = "RC-2025-0003", StartDate = new DateTime(2025, 7, 1), EndDate = new DateTime(2025, 7, 7), Status = "Active", TotalAmount = 280m, DiscountAmount = 0m, DepositAmount = 80m, Notes = "Business week", CreatedAt = new DateTime(2025, 6, 28) },
            new RentalContract { ContractId = 4, CustomerId = 4, EmployeeId = 5, BranchId = 3, ContractNumber = "RC-2025-0004", StartDate = new DateTime(2025, 7, 5), EndDate = new DateTime(2025, 7, 8), Status = "Active", TotalAmount = 105m, DiscountAmount = 0m, DepositAmount = 60m, Notes = "Beach weekend", CreatedAt = new DateTime(2025, 7, 2) },
            new RentalContract { ContractId = 5, CustomerId = 5, EmployeeId = 7, BranchId = 4, ContractNumber = "RC-2025-0005", StartDate = new DateTime(2025, 5, 1), EndDate = new DateTime(2025, 5, 4), Status = "Completed", TotalAmount = 56m, DiscountAmount = 0m, DepositAmount = 40m, Notes = null, CreatedAt = new DateTime(2025, 4, 28) },
            new RentalContract { ContractId = 6, CustomerId = 6, EmployeeId = 8, BranchId = 5, ContractNumber = "RC-2025-0006", StartDate = new DateTime(2025, 7, 10), EndDate = new DateTime(2025, 7, 15), Status = "Active", TotalAmount = 240m, DiscountAmount = 0m, DepositAmount = 70m, Notes = "Family trip", CreatedAt = new DateTime(2025, 7, 7) },
            new RentalContract { ContractId = 7, CustomerId = 7, EmployeeId = 9, BranchId = 6, ContractNumber = "RC-2025-0007", StartDate = new DateTime(2025, 4, 12), EndDate = new DateTime(2025, 4, 15), Status = "Completed", TotalAmount = 70m, DiscountAmount = 0m, DepositAmount = 50m, Notes = null, CreatedAt = new DateTime(2025, 4, 10) },
            new RentalContract { ContractId = 8, CustomerId = 8, EmployeeId = 4, BranchId = 2, ContractNumber = "RC-2025-0008", StartDate = new DateTime(2025, 6, 20), EndDate = new DateTime(2025, 6, 25), Status = "Completed", TotalAmount = 285m, DiscountAmount = 0m, DepositAmount = 90m, Notes = "Group van", CreatedAt = new DateTime(2025, 6, 18) },
            new RentalContract { ContractId = 9, CustomerId = 9, EmployeeId = 10, BranchId = 7, ContractNumber = "RC-2025-0009", StartDate = new DateTime(2025, 7, 12), EndDate = new DateTime(2025, 7, 14), Status = "Active", TotalAmount = 76m, DiscountAmount = 10m, DepositAmount = 50m, Notes = "Airport pickup", CreatedAt = new DateTime(2025, 7, 11) },
            new RentalContract { ContractId = 10, CustomerId = 10, EmployeeId = 11, BranchId = 8, ContractNumber = "RC-2025-0010", StartDate = new DateTime(2025, 5, 20), EndDate = new DateTime(2025, 5, 22), Status = "Completed", TotalAmount = 116m, DiscountAmount = 0m, DepositAmount = 80m, Notes = "Convertible weekend", CreatedAt = new DateTime(2025, 5, 18) },
            new RentalContract { ContractId = 11, CustomerId = 11, EmployeeId = 12, BranchId = 9, ContractNumber = "RC-2025-0011", StartDate = new DateTime(2025, 3, 5), EndDate = new DateTime(2025, 3, 8), Status = "Cancelled", TotalAmount = 0m, DiscountAmount = 0m, DepositAmount = 0m, Notes = "Customer cancelled", CreatedAt = new DateTime(2025, 3, 1) },
            new RentalContract { ContractId = 12, CustomerId = 12, EmployeeId = 13, BranchId = 10, ContractNumber = "RC-2025-0012", StartDate = new DateTime(2025, 6, 1), EndDate = new DateTime(2025, 6, 3), Status = "Completed", TotalAmount = 120m, DiscountAmount = 0m, DepositAmount = 60m, Notes = null, CreatedAt = new DateTime(2025, 5, 29) },
            new RentalContract { ContractId = 13, CustomerId = 13, EmployeeId = 2, BranchId = 1, ContractNumber = "RC-2025-0013", StartDate = new DateTime(2025, 7, 1), EndDate = new DateTime(2025, 7, 10), Status = "Active", TotalAmount = 750m, DiscountAmount = 0m, DepositAmount = 150m, Notes = "Long rental", CreatedAt = new DateTime(2025, 6, 27) },
            new RentalContract { ContractId = 14, CustomerId = 14, EmployeeId = 1, BranchId = 1, ContractNumber = "RC-2025-0014", StartDate = new DateTime(2025, 5, 8), EndDate = new DateTime(2025, 5, 10), Status = "Completed", TotalAmount = 50m, DiscountAmount = 0m, DepositAmount = 30m, Notes = null, CreatedAt = new DateTime(2025, 5, 6) },
            new RentalContract { ContractId = 15, CustomerId = 15, EmployeeId = 15, BranchId = 7, ContractNumber = "RC-2025-0015", StartDate = new DateTime(2025, 7, 8), EndDate = new DateTime(2025, 7, 12), Status = "Active", TotalAmount = 480m, DiscountAmount = 40m, DepositAmount = 120m, Notes = "Sports car", CreatedAt = new DateTime(2025, 7, 6) });
    }
