...
namespace CarRentalManagementSystem.Controllers
{
    public class CarCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,Description,BaseDailyRate,IsActive")] CarCategory carCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,Description,BaseDailyRate,IsActive")] CarCategory carCategory)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!CarCategoryExists(carCategory.CategoryId))
                    {
                        return NotFound();
                    }
                    else
